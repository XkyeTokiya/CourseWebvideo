...
handoff 是 script/outline 之后、章节制作之前默认不生成的可选上下文打包工具，不是强制门禁。生产作者的固定输入、Markdown 语法、输出职责和 normalizer 边界统一见 [handoff v4 作者契约卡](courseplay-handoff-v4-author-contract.md)；合成成功样例见 [canonical example](examples/courseplay-handoff-v4/)。
